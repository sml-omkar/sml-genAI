"""Generate a step-by-step PDF guide for integrating NXSS AI as a Microsoft Teams bot."""
...
OUT = os.path.join(os.path.dirname(__file__), "NXSS AI_Teams_Integration_Guide.pdf")
...
doc = SimpleDocTemplate(
    ...
    title="NXSS AI - Microsoft Teams Integration Guide",
...
story.append(Paragraph("NXSS AI — Microsoft Teams Integration Guide", title_style))
...
story.append(Paragraph(
    "NXSS AI is a FastAPI web service that exposes a bot endpoint at <b>/api/messages</b> "
...
story.append(numbered([
    ...
    "Set the <b>Name</b> to <b>NXSS AI Bot</b>.",
...
story.append(numbered([
    ...
    "Give it a description (e.g. <font face='Courier'>nxss-bot-secret</font>) and an expiry, then click <b>Add</b>.",
...
story.append(numbered([
    ...
    "Set a <b>Bot handle</b> (e.g. <font face='Courier'>nxss-ai-bot</font>).",
...
story.append(Spacer(1, 4))
story.append(code_block(
    "mkdir nxss-ai-app && cd nxss-ai-app\n"
    "nano manifest.json"
))
story.append(Spacer(1, 6))
...
story.append(code_block(
    ...
    "  },\n"
    "  \"name\": { \"short\": \"NXSS AI\", \"full\": \"NXSS AI Policy Assistant\" },\n"
    "  \"description\": {\n"
...
story.append(numbered([
    ...
    "Select <font face='Courier'>nxss-ai.zip</font> and click <b>Add</b>.",
]))
...
story.append(numbered([
    ...
    "Open <b>Teams apps &rarr; Manage apps &rarr; Upload new app</b> and upload <font face='Courier'>nxss-ai.zip</font>.",
    "Submit/publish the app; define an app setup policy so it appears for the relevant employees.",
    "Employees then go to <b>Apps</b>, search <b>NXSS AI</b>, click <b>Add</b>, and use it in a 1:1 chat.",
]))
...
story.append(Paragraph(
    ...
    "NXSS AI in the apps store, and add it to their chat to start asking policy questions.", body))
