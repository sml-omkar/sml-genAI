"""Build the installable NXSS AI Teams app package (.zip).
...
manifest.json + color.png + outline.png into teams_app/nxss-ai.zip.
"""
...
OUT_ZIP = os.path.join(TEAMS_DIR, "nxss-ai.zip")
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Build NXSS AI Teams app package")
    p.add_argument("--domain", help="Public HTTPS base URL, e.g. https://nxss.example.com")
