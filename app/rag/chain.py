...
def _no_context_llm_call(question: str) -> str:
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are NXSS AI, a friendly company assistant. Be warm and conversational."},
...
GREETING_RESPONSES = {
    ...
    "who are you": "I'm NXSS AI -- your company policy assistant. I can answer questions about company policies, IT guidelines, HR procedures, and more. Just ask me anything!",
...
DEFAULT_GREETING = "Hey! I'm NXSS AI. Ask me anything about company policies, IT guidelines, HR procedures, or any other company documents."


SYSTEM_PROMPT = """You are NXSS AI, a friendly and helpful company assistant. You answer employee questions using company documents.
...
NO_CONTEXT_PROMPT = """You are NXSS AI, a friendly company assistant.
...
async def query_rag(
    ...
    try:
        ...
        if _is_echo(answer):
            retry_msgs = [
                {"role": "system", "content": "You are NXSS AI, a friendly assistant. Answer warmly in 1-3 sentences. Do NOT copy text — write your own answer."},
        ...
        if any(p in answer.lower() for p in unsure):
            retry_msgs = [
                {"role": "system", "content": "You are NXSS AI. Answer using ONLY the facts below. Extract the specific answer — do not say you don't know if the facts contain it. Be friendly."},
